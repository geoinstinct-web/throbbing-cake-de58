...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/throbbing-cake-de58
```

A live public deployment of this template is available at [https://throbbing-cake-de58.templates.workers.dev](https://throbbing-cake-de58.templates.workers.dev)
